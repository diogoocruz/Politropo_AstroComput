...
plt.axvline(x=2.634235837475673, color="red", label="Valor de n_estrela")
plt.axvline(x=2.634235837475673+np.std(arn[:ind]), color="orange", label="Desvio padrão = "+str(round(np.std(arn[:ind]),1)))
